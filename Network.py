...
class Network:
    ...
    def simulate_max_time(self, optimizer, max_time=10000, file_name="log/information_log.csv"):
        file_name = "./log/Q_learning2nd/thaydoisonode/result_0_intervals/gamma0.6/information_log" + str(self.index) +".csv"
        filenametxt = "./log/Q_learning2nd/thaydoisonode/result_0_intervals/gamma0.6/networkinfor" + str(self.index) +".txt"
