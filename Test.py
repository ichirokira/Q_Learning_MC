...
for index in range(0,1):
    ...
    file_name_target = "./log/Q_learning2nd/thaydoisonode/result_0_intervals/gamma0.7/regression_target_data" + str(index) + ".csv"
    information_log_t = open(file_name_target, "a+")
    writer_t = csv.DictWriter(information_log_t, fieldnames=["delta"])
    writer_t.writeheader()
    file_name_data = "./log/Q_learning2nd/thaydoisonode/result_0_intervals/gamma0.7/regression_data" + str(index) + ".csv"
    ...
    file_name_w = "./log/Q_learning2nd/thaydoisonode/result_0_intervals/gamma0.7/regression_weights" + str(index) + ".csv"
